...
MainMenuColorLabels g_Labels = {
    ...
    {
        _SL(LABEL_SIZE, "Item"),
        _SL(LABEL_SIZE, "Magic"),
        _SL(LABEL_SIZE, "Materia"),
        _SL(LABEL_SIZE, "Equip"),
        _SL(LABEL_SIZE, "Status"),
        _SL(LABEL_SIZE, "Order"),
        _SL(LABEL_SIZE, "Limit"),
        _SL(LABEL_SIZE, "Config"),
        _SL(LABEL_SIZE, "PHS"),
        _SL(LABEL_SIZE, "Save"),
        _SL(LABEL_SIZE, "Uso"),
        _SL(LABEL_SIZE, "Beginner"),
        _SL(LABEL_SIZE, "Uso"),
        _SL(LABEL_SIZE, "Uso"),
        _SL(LABEL_SIZE, "Time"),
        _SL(LABEL_SIZE, "Gil"),
        _SL(LABEL_SIZE, "next level"),
        _SL(LABEL_SIZE, "Limit level"),
        _SL(LABEL_SIZE, "Tutorial"),
        _SL(LABEL_SIZE, "Under"),
        _SL(LABEL_SIZE, "LEVEL UP"),
        _SL(LABEL_SIZE, "Fury"),
        _SL(LABEL_SIZE, "Sadness"),
    },
};
// clang-format on
