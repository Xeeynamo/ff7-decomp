...
INCLUDE_ASM("asm/us/main/nonmatchings/psxsdk/libcd/sys", CdStatus);

INCLUDE_ASM("asm/us/main/nonmatchings/psxsdk/libcd/sys", CdMode);

INCLUDE_ASM("asm/us/main/nonmatchings/psxsdk/libcd/sys", CdLastCom);
