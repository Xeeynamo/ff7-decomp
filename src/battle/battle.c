...
void BattleSetFocusedActor(s32 arg0) {
    s32 i;
...
void BattleQueueEffect(s32, s32, s32, s32, s32, s32, s32);
...
Unk800A2F4C* BattleQueue1GetPtr(void) {
...
void BattleDropSupersededQueuedActions(void) {
    s32 slot[10];
    s32 i;
    s32 actor;
    s32 prev;
...
void BattleCopyBattleActionToBattleQueue(Unk800A3D4C* arg0) {
    s32 category;
    s32 i;
...
void BattleAddBattleActionToBattleQueue(s32 arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4) {
    Unk800A3D4C sp;
...
s32 BattleGetManipulatorIdByEnemyUnitId(s32 arg0) {
    s32 i;
...
s32 BattleRunToResultScreen(void) {
    s32 ret;
    s32 i;
...
s32 BattleRunEscapeSequence(void) {
    s32 ret;
    s32 i;
...
u8 func_800A4B3C(s32 index, s32 arg1) {
    if (arg1 != -1) {
        g_battleModel[index].jointCount = arg1;
    }
    return g_battleModel[index].jointCount;
}
...
s32 BattleGetBerserkToadAttackTypeId(s32 arg0) { return D_800F39F0[arg0][0]; }

s32 BattleGetManipIdByPlayerUnitId(s32 arg0) {
    s32 temp_v1;
...
void BattleEnableLimitToPlayerWithoutSpeed(s32 arg0) {
    s32 temp_v0;
...
void BattleRemoveUnitReservedItem(s16 arg0, s16 arg1) {
    s32 i;
...
void BattleAddUnitReservedItem(s16 arg0, s16 arg1) {
    s32 i;
...
s32 BattlePickRandomThrowItem(void) {
    u16 list[320];
    s32 n;
    s32 i;
    s32 ret;
...
s32 BattleExpandScriptToBuffer(u8* src, u16* patch) {
    u8 buf[0x100];
    s32 len;
    s32 slot;
    s32 i;
...
s32 GetEnemyAiScriptOffs(u16* arg0, s32 arg1, s32 arg2) {
    s32 var_v1 = 0;
    u16* temp_a0;
...
void func_800A61D4(void) {
    ...
    for (var_s0 = 0; var_s0 < 8; var_s0 += 1) {
        if ((D_800F5F44.D_800F7DBC >> var_s0) & 1) {
            ...
            temp_v0 = GetEnemyAiScriptOffs(D_800F5F44._5.unk0, g_BattleState.sceneID & 3, var_s0);
            if (temp_v0 != 0) {
...
u16 BattleGetItemFromSlot(s32 arg0) {
    u16 var_a0;
    u8* countPtr;
...
void func_800A70C4(s32 arg0, s32 arg1) {
    BattleQueueEffect(arg0, 0x34, 2, D_800708D0[arg1][1], 0, 9, g_BattleState.combatant[arg0].status);
}
...
void BattleRemoveUnitReservedItem(s16, s16);
...
void BattleLoadActionAttackData(void) {
    ...
    BattleSetActionStatusChange(atk->statusChange, atk->statuses);
...
void BattleSetActionStatusChange(u32 arg0, s32 arg1) {
...
void BattleDropDyingEnemiesFromTargets(void) {
    s32 mask;
    s32 i;
...
void BattleLearnEnemySkill(void) {
    u16 id;
...
s32 BattleIsDamageNullified(s32 arg0) {
...
// caller) uses earlier.
void BattleQueueUnassignedResultDisplay(Unk800FA9D0* arg0) {
    s8 temp_v1;
...
void BattleApplyDefaultAbsorbEffect(void) {
    s32 t0;
    s32 a3;
    s32 result;
...
void BattleAddStringToDisplay(s32 arg0, s32 arg1, s32 arg2, s16* arg3) {
    func_800A31A0(arg0, 2, arg2, BattleExpandScriptToBuffer(SysGetPtrToUncompKernBattleTxtWithId(arg1), arg3) + 0x100);
}
...
void BattleQueueEffect(s32 arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg5, s32 arg6) {
    Unk800A2F4C* unk;
    Unk800FA9D0* act;
...
s32 BattleScriptCompare(s32 lhs, s32 rhs) {
...
s32 BattleScriptCollapseVarBank(s32 arg0) {
    s32 i;
    s32 v;
    s32 mask;
...
AttackData* BattleGetAttackData(s32);
...
AttackData* BattleGetAttackData(s32 id) {
    AttackData* ret;
    s32 i;
