    ...
    while (1) {
        ...
        case 6:
            ...
            for (i = 4; i < D_800F7E04[0] + 4; i++) {
                g_battleModel[i].animationScriptFlags |= 4;
            }
            D_80163C7C = 2;
            break;
        case 2:
            ...
            if ((u8)D_80166F64 == 3 && D_801518DC == 0) {
                ...
                D_80163C7C = 3;
                g_battleModel[0].animationScriptFlags |= 4;
                g_battleModel[1].animationScriptFlags |= 4;
                g_battleModel[2].animationScriptFlags |= 4;
            }
            break;
        case 3:
            BattleUpdateRender();
...
static void func_800B3E2C(void) {
    ...
    D_801516A0 = 0;
    D_800F8380 = 0;
    for (i = 0; i < LEN(g_battleModel); i++) {
        g_battleModel[i].deathType = 1;
    }
    for (i = 2; i >= 0; i--) {
        D_800F9F28[i] = 0;
    }
    var_a0 = D_801590CC;
    g_battleModel[var_a0].effectId = 0;
    D_800F8374 = 0xE;
...
static void BattleUpdateRender(void) {
    ...
    func_800B8438();
    for (i = 0; i < 10; i++) {
        if (g_battleModel[i].deathType == 0) {
            D_800F7DE4 = 0;
            break;
        }
        if (D_80162080 == 0) {
...
static void func_800B8268(void) {
    ...
    while (i < 10) {
        *var_a1 = D_801636B8[i].D_801636B9;
        if (!(D_80151200[i].D_8015120C & 8) && g_battleModel[i].animationId != *var_a1 &&
            g_battleModel[i].deathType == var_t1) {
            g_battleModel[i].animationScriptFlags |= 1;
            g_battleModel[i].animationId = *var_a1;
        }
        var_a1++;
        i += 1;
    }
...
void func_800B8438(void) {
    ...
    func_800B85E0();
    func_800BC81C(D_800F8370, g_battleModel[D_801590CC].effectId);
...
static void func_800B85E0() {
    ...
    if (D_800F7ED4 != 100 && D_800FA6B8) {
        ...
        BattleQueue1CameraInit();
        for (i = 0; i < 3; i++) {
            g_battleModel[i].animationScriptFlags |= 0x20;
    ...
    if (D_800F9D9C != 100) {
        ...
        if (g_BattleMode & 8) {
            for (; i < 3; i++) {
                g_battleModel[i].animationScriptFlags |= 1;
                g_battleModel[i].animationId = D_801636B8[i].D_801636B9;
                g_battleModel[i].animationScriptFlags |= 0x20;
                D_80151200[i].D_80151200 = D_801636B8[i].D_801636C0;
            }
            D_800F9D9C = 100;
...
static void func_800B8E48(s32 arg0) {
    ...
    temp_a0 = arg0 & 0xFF;
    g_battleModel[temp_a0].deathType = 1;
    g_battleModel[temp_a0].flags &= 0x7F;
...
static void func_800BA40C(void) {
    ...
    for (i = 0; i < 3; i++) {
        if (!(g_battleModel[i].flags & 2)) {
            param = i;
            func_800C1908(param);
            func_800BA598(i);
            if (g_battleModel[i].modelFlags & 0x80) {
                func_800BB2A8(param);
                func_800BB030(i);
            }
        }
...
static void func_800BB030(s16 arg0) {
    ...
    SetFarColor(g_battleModel[arg0].additionalColorR, g_battleModel[arg0].additionalColorG,
                g_battleModel[arg0].additionalColorB);
    SetRotMatrix(&g_battleModel[arg0].m);
    SetTransMatrix(&g_battleModel[arg0].m);
    ...
    for (i = 0; i < D_800FA6D8[arg0].unk3C; i++) {
        ...
        unk->unk8 = 0;
        unk->unkA = g_battleModel[arg0].additionalColorAlpha;
        unk->unkC = 0x20;
        unk->unkE = g_battleModel[arg0].clutOffset;
        if (g_battleModel[arg0].flags & 4) {
            continue;
        }
...
static void func_800C17A0(s32 arg0, s32 arg1) {
    ...
    case 0:
        g_battleModel[arg0].additionalColorAlpha = 0;
        break;
    case 1:
        g_battleModel[arg0].additionalColorAlpha = 0x800;
        break;
    case 2:
        g_battleModel[arg0].additionalColorAlpha = 0xC00;
        break;
    }
    g_battleModel[arg0].additionalColorR = D_800EA19C[arg1][1];
    g_battleModel[arg0].additionalColorG = D_800EA19C[arg1][2];
    g_battleModel[arg0].additionalColorB = D_800EA19C[arg1][3];
    g_battleModel[arg0].animationState = 0;
}
...
static void func_800C1908(u8 arg0) {
    ...
    temp_s0 = arg0;
    if (g_battleModel[temp_s0].animationScriptFlags & 0x20) {
        if (temp_s0 < 4) {
        ...
        g_battleModel[temp_s0].animationScriptFlags &= 0xDF;
    }
    temp_a1 = arg0;
    if (D_80151200[temp_a1].D_80151235 == 0) {
        ...
        if (D_80151200[temp_a1].D_80151200 & 0x40) {
            if (g_battleModel[temp_a1].animationId == D_80163784[temp_a1]) {
                g_battleModel[temp_a1].rootRotation.vy += 0x100;
            }
        }
        var_a0 = arg0;
        if (D_80151200[var_a0].D_80151200 & 0x400000 && g_battleModel[var_a0].animationId == D_80163784[var_a0]) {
            if (g_battleModel[var_a0].defaultRotationX == 0) {
                g_battleModel[var_a0].rootRotation.vy = 0x800;
            } else {
                g_battleModel[var_a0].rootRotation.vy = 0;
            }
        }
        var_a0 = arg0;
        if (g_battleModel[var_a0].flags & 8) {
            if (g_battleModel[var_a0].animationState < 0x10) {
                g_battleModel[var_a0].additionalColorAlpha += 0x80;
            } else {
                g_battleModel[var_a0].additionalColorAlpha -= 0x80;
            }
            g_battleModel[arg0].animationState--;
            g_battleModel[arg0].animationState &= 0x1F;
        }
    }
}
...
static void func_800C55B8(void) {
    ...
    g_battleModel[D_801621F0[D_801590D4].D_801621F6].modelScale += D_801621F0[D_801590D4].D_801621F2;
