...
static void func_800B8268(void) {
    ...
    while (i < 10) {
        *var_a1 = D_801636B8[i].D_801636B9;
        if (!(D_80151200[i].D_8015120C & 8) && D_801518E4[i].animId != *var_a1 &&
            D_801518E4[i].D_8015190A == var_t1) {
            D_801518E4[i].D_80151922 |= 1;
            D_801518E4[i].animId = *var_a1;
        }
        var_a1++;
        i += 1;
    }
...
static void func_800B85E0() {
    ...
    if (D_800F9D9C != 100) {
        ...
        if (g_BattleMode & 8) {
            for (; i < 3; i++) {
                D_801518E4[i].D_80151922 |= 1;
                D_801518E4[i].animId = D_801636B8[i].D_801636B9;
                D_801518E4[i].D_80151922 |= 0x20;
                D_80151200[i].D_80151200 = D_801636B8[i].D_801636C0;
            }
            D_800F9D9C = 100;
...
static void func_800C1908(u8 arg0) {
    ...
    if (D_80151200[temp_a1].D_80151235 == 0) {
        ...
        if (D_80151200[temp_a1].D_80151200 & 0x40) {
            if (D_801518E4[temp_a1].animId == D_80163784[temp_a1]) {
                D_801518E4[temp_a1].unk160.vy += 0x100;
            }
        }
        var_a0 = arg0;
        if (D_80151200[var_a0].D_80151200 & 0x400000 && D_801518E4[var_a0].animId == D_80163784[var_a0]) {
...
static void func_800C55B8(void) {
    ...
    D_801518E4[D_801621F0[D_801590D4].D_801621F6].scale += D_801621F0[D_801590D4].D_801621F2;
