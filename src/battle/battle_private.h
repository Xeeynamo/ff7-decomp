...
extern s32 TimClutLoadQueueIndex;
extern s32 TimImageLoadQueueIndex;
...
extern RECT TimClutLoadQueue[];
extern RECT TimImageLoadQueue[];
...
extern s16 g_BattleReflectMask;
