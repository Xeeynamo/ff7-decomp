...
extern char HexDigits[16]; // '0' to 'F' for hex digits
...
void func_800AA180(Unk80074EA4* str, FieldLine* arg1);
void func_800AAB24(struct GpuBuf* buf);
s32 func_800A9CE8(FieldLine*, u_long*, u_long*);
void DebugPrintOpcode(char* str, s32 arg1);
u8 func_800BEE10(s16 str, s16 arg1);
void func_800BF3AC(s16 str, s16 arg1, u8 value);
s16 func_800BF908(s16 str, s16 arg1);
void func_800C0248(s16 str, s16 arg1, s16 value);
...
static void AppendString(char* dest, char* src);
static void DigitToHex(s32 val, char* msg_out);
static void U8ToHex(s32 val, char* msg_out);
static void U16ToHex(s32 val, char* msg_out);
...
static s32 func_800A41CC(SVECTOR* str, long* arg1) {
    long sp10;
    long sp14;
    s32 ret;
    ...
    SetGeomOffset(0, 0);
    ret = RotTransPers(str, arg1, &sp10, &sp14);
    PopMatrix();
    return ret;
}
...
s16 func_800A8600(u8 str) { return D_800DF120[str][0]; }

s16 func_800A8620(u8 str) { return D_800DF120[str][1]; }
...
static void func_800A8DF4(s32* str, s16* arg1, s16* arg2) {
    str[0] = arg1[0] - arg2[0];
    str[1] = arg1[1] - arg2[1];
    str[2] = arg1[2] - arg2[2];
}
...
static void field_debug_page_inits(void);
void func_800BA65C(s32 str) {
    if (D_8007EBE0) {
        func_800D4BFC();
        func_800BC338();
        func_800D7D6C();
    ...
    if (D_80071E2C) {
        func_8001F1BC(&D_80083274, 4, str, g_FieldState->unk0 ^ 1);
    }
    func_800BC438(str);
}
...
u8 func_800BBF74(s16 entityId, s16 priority, s16 scriptId) {
    ...
    if (DebugLevel & 3) {
        switch (scriptId) {
        case 1: // Pressed OK.
            CopyString(D_800E4288, "Talk=");
            break;
        case 2: // Pushed / within entity's collision radius.
            CopyString(D_800E4288, "Push=");
            break;
        case 3: // Across line.
            CopyString(D_800E4288, "Acrs=");
            break;
        case 4: // Touching line.
            CopyString(D_800E4288, "Toch=");
            break;
        case 5: // Started touching line.
            CopyString(D_800E4288, "TochON =");
            break;
        case 6: // Ended touching line.
            CopyString(D_800E4288, "TochOFF=");
            break;
        }
        // Prints entity name.
        AppendString(D_800E4288, (char*)g_FieldScripts +
...
static void func_800BECA4(const char* str, s32 val, s32 kind) {
    if (!(D_80071E24 & 4) || D_80114498[g_CurrentEntity]) {
        CopyString(D_800E4254, str);
        switch (kind) {
        case 1:
            DigitToHex(val, D_800E4288); // to single hex digit
            break;
        case 2:
            U8ToHex(val, D_800E4288); // to double hex digit
            break;
        case 4:
            U16ToHex(val, D_800E4288); // to four hex digits
            break;
        default:
            CopyString(D_800E4288, D_800A0270);
            break;
        }
        AppendString(D_800E4254, D_800E4288);
        if (DebugLevel & 1) {
...
#else
static u8 func_800BEE10(s16 str, s16 arg1) {
    s32 indx;
    u8 value;
    u8 bankId;
...
#else
static void func_800BF3AC(s16 str, s16 arg1, u8 value) {
    u8 bankId;
    s32 indx;
...
#else
static s16 func_800BF908(s16 str, s16 arg1) {
    u8 bankId;
    s32 indx;
    s16 value;
...
#else
static void func_800C0248(s16 str, s16 arg1, s16 value) {
    u8 bankId;
    s32 indx;
...
s32 OpcodeFuncBad(void) {
    if (DebugLevel & 3) {
        U8ToHex(D_8009A058, D_800E4288);
        AppendString(D_800E4288, "???");
...
s32 func_800C33B4(s16 type, u8 target, u8 priority, u8 scriptId) {
    ...
    if (DebugLevel & 3) {
        CopyString(D_800E4288, "rq=");
        AppendString(D_800E4288, (char*)((s32)g_FieldScripts) +
...
static void func_800CDC14(s16* str) {
    str[0] = 0;
    str[1] = 0;
    str[2] = 0;
    str[3] = 0;
...
void func_800D4E88(s16 str, s16 arg1) { D_8008327E[str * 24] = arg1; }
...
static void field_debug_page_inits(void) {
    ...
    CopyString(D_800E4254, "Authr:");
    AppendString(D_800E4254, g_FieldScripts->author);
    func_800D9F00(5, D_800E4254);
    CopyString(D_800E4254, "Event:");
    AppendString(D_800E4254, g_FieldScripts->name);
    func_800D9F00(5, D_800E4254);
    func_800D9F00(5, "  Go");
...
s32 func_800D8498(s16 str) { return D_800E08C0[str * 378] == 0; }
...
// 4 state cycle counter (Mod 4)
// 0 -> 1 -> 2 -> 3 -> 0 -> 1 -> ...
static void func_800DA310(void) { D_800E4210 = (D_800E4210 + 1) & 3; }

// Little strncpy-like helper funtion
static void CopyString(char* dst, const char* src) {
    if (*src) {
        do {
            *dst++ = *src++;
...
// Little strcat-like helper funtion (this returns void)
static void AppendString(char* dest, char* src) {
    if (*dest != '\0') {
        while (*++dest != '\0') {
        }
...
// Little strlen-like helper funtion
static s32 StringLength(char* str) {
    s32 len = 0;
...
// Little memcopy-like helper funtion
static void CopyBytes(char* dst, char* src, s32 len) {
    s32 i;
    for (i = len - 1; i != -1; i--) {
        *dst = *src;
        src++;
...
static void DigitToHex(s32 val, char* msg_out) {
    msg_out[1] = '\0';
    msg_out[0] = HexDigits[val & 0xF];
}

static void U8ToHex(s32 val, char* msg_out) {
    msg_out[2] = '\0';
    msg_out[0] = HexDigits[(val & 0xF0) >> 4];
    msg_out[1] = HexDigits[val & 0xF];
}

static void U16ToHex(s32 val, char* msg_out) {
    msg_out[4] = '\0';
    msg_out[0] = HexDigits[(val & 0xF000) >> 0xC];
    msg_out[1] = HexDigits[(val & 0xF00) >> 8];
    msg_out[2] = HexDigits[(val & 0xF0) >> 4];
    msg_out[3] = HexDigits[val & 0xF];
}
