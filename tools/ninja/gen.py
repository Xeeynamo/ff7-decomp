...
def add_splat_config(file_name: str):
    ...
    if is_main:
        ...
        nw.build(
            ...
            inputs=[
                f"{work_dir}/dschange.elf",
                f"{work_dir}/ending.elf",
                f"{work_dir}/brom.elf",
                f"{work_dir}/battle.elf",
                f"{work_dir}/field.elf",
                f"{work_dir}/bginmenu.elf",
                f"{work_dir}/cnfgmenu.elf",
                f"{work_dir}/savemenu.elf",
            ],
        )
        nw.build(
            rule="psx-ld",
