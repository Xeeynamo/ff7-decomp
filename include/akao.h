...
typedef enum {
    ...
    AKAO_PLAY_SOUND_SLOT1               = 0x29,
    AKAO_PLAY_SOUND_SLOT0               = 0x2A,
    AKAO_PLAY_SOUND_SLOT3               = 0x2B,
    AKAO_PLAY_MENU_SOUND                = 0x30,
    AKAO_PLAY_SOUND_DIRECT              = 0x34,
    AKAO_SET_STEREO_MODE                = 0x80,
    AKAO_SET_MONO_MODE                  = 0x81,
    AKAO_RESET_MUSIC_AND_SOUND_VOL      = 0x82,
    ...
    AKAO_FLUSH_PENDING_SOUND_UPDATES    = 0x9C,
    AKAO_APPLY_PENDING_SOUND_UPDATES    = 0x9D,
    AKAO_SET_SOUND_VOL_BALANCE_SLOT2    = 0xA0,
    AKAO_SET_SOUND_VOL_BALANCE_SLOT1    = 0xA1,
    AKAO_SET_SOUND_VOL_BALANCE_SLOT0    = 0xA2,
    AKAO_SET_SOUND_VOL_BALANCE_SLOT3    = 0xA3,
    AKAO_SLIDE_SOUND_VOL_BALANCE_SLOT2  = 0xA4,
    AKAO_SLIDE_SOUND_VOL_BALANCE_SLOT1  = 0xA5,
    AKAO_SLIDE_SOUND_VOL_BALANCE_SLOT0  = 0xA6,
    AKAO_SLIDE_SOUND_VOL_BALANCE_SLOT3  = 0xA7,
    AKAO_SET_SOUND_PAN_SLOT2            = 0xA8,
    AKAO_SET_SOUND_PAN_SLOT1            = 0xA9,
    AKAO_SET_SOUND_PAN_SLOT0            = 0xAA,
    AKAO_SET_SOUND_PAN_SLOT3            = 0xAB,
    AKAO_SLIDE_SOUND_PAN_SLOT2          = 0xAC,
    AKAO_SLIDE_SOUND_PAN_SLOT1          = 0xAD,
    AKAO_SLIDE_SOUND_PAN_SLOT0          = 0xAE,
    AKAO_SLIDE_SOUND_PAN_SLOT3          = 0xAF,
    AKAO_SET_SOUND_PITCH_SLOT2          = 0xB0,
    AKAO_SET_SOUND_PITCH_SLOT1          = 0xB1,
    AKAO_SET_SOUND_PITCH_SLOT0          = 0xB2,
    AKAO_SET_SOUND_PITCH_SLOT3          = 0xB3,
    AKAO_SLIDE_SOUND_PITCH_SLOT2        = 0xB4,
    AKAO_SLIDE_SOUND_PITCH_SLOT1        = 0xB5,
    AKAO_SLIDE_SOUND_PITCH_SLOT0        = 0xB6,
    AKAO_SLIDE_SOUND_PITCH_SLOT3        = 0xB7,
    AKAO_SET_ALL_SOUND_VOL_BALANCE      = 0xB8,
    AKAO_SLIDE_ALL_SOUND_VOL_BALANCE    = 0xB9,
    AKAO_SET_ALL_SOUND_PAN              = 0xBA,
    AKAO_SLIDE_ALL_SOUND_PAN            = 0xBB,
    AKAO_SET_ALL_SOUND_PITCH            = 0xBC,
    AKAO_SLIDE_ALL_SOUND_PITCH          = 0xBD,
    ...
    AKAO_SAVE_SOUND_STATE               = 0xF4,
    AKAO_RESTORE_SOUND_STATE            = 0xF5,
