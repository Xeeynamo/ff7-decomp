...
typedef enum {
    LBA_INSTR_ALL = 219,         // SOUND/INSTR.ALL
    LBA_EFFECT = 455,            // SOUND/EFFECT.ALL
    LBA_INSTR_DAT = 480,         // SOUND/INSTR.DAT
    LBA_INSTR2_ALL = 484,        // SOUND/INSTR2.ALL
    LBA_INSTR2_DAT = 607,        // SOUND/INSTR2.DAT
