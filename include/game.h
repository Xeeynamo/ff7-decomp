...
typedef enum {
    AKAO_CMD_PLAY_MUSIC = 0x10,
    AKAO_CMD_PLAY_MUSIC_UNK14 = 0x14,
    AKAO_CMD_PLAY_MUSIC_UNK15 = 0x15,
    AKAO_CMD_PLAY_MUSIC_RESUME = 0x18,
    AKAO_CMD_PLAY_MUSIC_UNK19 = 0x19,
    AKAO_CMD_TOGGLE_AMBIENT = 0x20,
    AKAO_CMD_UNK21 = 0x21,
    AKAO_CMD_UNK22 = 0x22,
    AKAO_CMD_UNK23 = 0x23,
    AKAO_CMD_TOGGLE_AMBIENT_1PARAM = 0x24,
    AKAO_CMD_UNK21_2PARAMS = 0x25,
    AKAO_CMD_UNK22_3PARAMS = 0x26,
    AKAO_CMD_UNK23_4PARAMS = 0x27,
    AKAO_CMD_UNK28 = 0x28,
    AKAO_CMD_UNK29 = 0x29,
    AKAO_CMD_UNK2B = 0x2B,
    AKAO_CMD_PLAY_SFX = 0x30,
    AKAO_CMD_UNK98 = 0x98,
    AKAO_CMD_UNK99 = 0x99,
    AKAO_CMD_UNK9A = 0x9A,
    AKAO_CMD_UNK9B = 0x9B,
    AKAO_CMD_UNK9C = 0x9C,
    AKAO_CMD_UNK9D = 0x9D,
    AKAO_CMD_BATTLE_SOUND_A0 = 0xA0,
    AKAO_CMD_STOP_AMBIENT = 0xBC,
    AKAO_CMD_UNKBD = 0xBD,
    AKAO_CMD_SET_MODE_STEREO = 0x80,
    AKAO_CMD_SET_MODE_MONO = 0x81,
    AKAO_CMD_UNK82 = 0x82, // unknown, blasts volume to maximum
    AKAO_CMD_SET_MUSIC_VOLUME = 0xC0,
    AKAO_CMD_FADE_OUT = 0xC1,
    AKAO_CMD_UNKD0 = 0xD0,
    AKAO_CMD_UNKD1 = 0xD1,
    AKAO_CMD_UNKD2 = 0xD2,
    AKAO_CMD_UNKD4 = 0xD4,
    AKAO_CMD_UNKD5 = 0xD5,
    AKAO_CMD_UNKD6 = 0xD6,
    AKAO_CMD_UNKD0_D4_PAIR = 0xD8,
    AKAO_CMD_UNKD1_D5_PAIR = 0xD9,
    AKAO_CMD_UNKD2_D6_PAIR = 0xDA,
    AKAO_CMD_STOP_SOUND = 0xF1,
    AKAO_CMD_FIELD_MUSIC_INIT = 0xF2,
    AKAO_CMD_STOP_ALL = 0xF4,
    AKAO_CMD_RESET_FIELD_MUSIC = 0xF5,
} AkaoCommandId;
